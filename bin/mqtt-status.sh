...
do
    ...
    VAL_FLAG=$(convert_binary_value $(get_icamera_value_for_key "MASwitch")) # Motion detection (1=On, 2=Off)
    mqtt_publish "/motion_detection" "${VAL_FLAG}"

#    cmd jpeg 1 -n > /opt/wz_mini/www/snapshot.jpg
