...
# set expiry for one minute after last status update
EXPIRE_AFTER=${STATUSINTERVAL}
...
mqtt_publish "${DISCOVERY_PREFIX}/switch/${NODE_ID}/motion_detection/config" "{\"name\": \"${NODE_ID} Motion Detection\", \"unique_id\": \"${NODE_ID}-motion-detection\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:motion-sensor\", \"state_topic\": \"${TOPIC_BASE}/motion_detection\", \"command_topic\": \"${TOPIC_BASE}/motion_detection/set\"}"
...
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/last_boot/config" "{\"name\": \"${NODE_ID} Last Boot\", \"unique_id\": \"${NODE_ID}-lastboot\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.last_boot }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/current_time/config" "{\"name\": \"${NODE_ID} Current Time\", \"unique_id\": \"${NODE_ID}-tstime\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.ts }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/ipaddr/config" "{\"name\": \"${NODE_ID} IP Address\", \"unique_id\": \"${NODE_ID}-ipaddr\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.ip }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/link_quality/config" "{\"name\": \"${NODE_ID} Link Quality\", \"unique_id\": \"${NODE_ID}-linkquality\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.link_quality }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/signal_level/config" "{\"name\": \"${NODE_ID} Wifi RSSI\", \"unique_id\": \"${NODE_ID}-wifirssi\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.signal_level }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/noise_level/config" "{\"name\": \"${NODE_ID} Wifi Noise Level\", \"unique_id\": \"${NODE_ID}-wifinoise\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.noise_level }}\", \"entity_category\": \"diagnostic\"}"
mqtt_publish "${DISCOVERY_PREFIX}/sensor/${NODE_ID}/bit_rate/config" "{\"name\": \"${NODE_ID} Wifi Connection Bitrate\", \"unique_id\": \"${NODE_ID}-wifibitrate\", \"device\": ${DEVICE_JSON}, \"icon\": \"mdi:run\", \"state_topic\": \"${TOPIC_BASE}/status\", \"value_template\": \"{{ value_json.bit_rate }}\", \"entity_category\": \"diagnostic\"}"


# Motion
mqtt_publish "${DISCOVERY_PREFIX}/binary_sensor/${NODE_ID}/motion/config" "{\"name\": \"${NODE_ID} Motion Detected\", \"unique_id\": \"${NODE_ID}-motion-detected\", \"expire_after\": ${EXPIRE_AFTER}, \"device\": ${DEVICE_JSON}, \"device_class\": \"motion\", \"state_topic\": \"${TOPIC_BASE}/motion/detected\"}"
